...
screen -dmS prove_formalizations_tir bash -c '
     ...
     python conjecturing_agents/prove_formalizations.py \
       ...
       --lean-project-dir /workspace/mathlib4 \
       --prover-type tir \
       --tir-ollama-model qwen3.6 \
       --tir-tokenizer-path tokenizers/Qwen3.6-35B-A3B \
       --tir-temperature 0.6 \
       --tir-top-p 0.95 \
       --tir-top-k 20 \
       --tir-min-p 0.0 \
       --tir-presence-penalty 0.0 \
       --tir-repeat-penalty 1.0 \
       --parallelism 6 \
       --limit-prover-tokens 16000 \
...
screen -dmS prove_formalizations_tir bash -c '
     ...
     python conjecturing_agents/prove_formalizations.py \
       ...
       --lean-project-dir /workspace/mathlib4 \
       --prover-type tir \
       --tir-ollama-model qwen3.5 \
       --tir-tokenizer-path tokenizers/Qwen3.5-27B \
       --tir-temperature 0.6 \
       --tir-top-p 0.95 \
       --tir-top-k 20 \
       --tir-min-p 0.0 \
...
## To test locally:
```sh
cp -r logs/conjecture_formalization_logs_20mins logs/test_prove_formalizations && \
  python conjecturing_agents/prove_formalizations.py \
...
screen -dmS prove_formalizations_tir bash -c '
     ...
     python conjecturing_agents/prove_formalizations.py \
       ...
       --lean-project-dir /workspace/mathlib4 \
       --prover-type tir \
       --tir-ollama-model gemma4 \
       --tir-no-think \
       --tir-tokenizer-path tokenizers/gemma-4-31B-it \
       --parallelism 6 \
       --limit-prover-tokens 16000 \
...
- `--tir-no-think` disables extended thinking for models that don't support it (e.g. Gemma 4).
